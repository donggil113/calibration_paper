...
unchanged at every site we tested.  What it costs instead is small and bounded:
because the correction needs one scalar rather than a whole recalibration map,
measuring the prevalence on a few dozen adjudicated target cases recovers
essentially the entire available benefit.
